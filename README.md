...
This dataset contains state-level apparent per capita alcohol consumption records, including total ethanol consumption and breakdowns by beverage type (beer, wine, and spirits). 
